...
function draw() {
  ...
  if (Etapa <= -1) {
    ...
    if (MotrarAnuncio == 1) {
      ...
      if (video.time() >= 0 && video.time() <= 4) {
        
        tint(255, map(video.time(), 0, 4, 0, 255));
        
      }
      
      if (video.time() >= 67 && video.time() <= 71) {
        
        tint(255, map(video.time(), 67, 71, 255, 0));
        
      }
      
      if (video.time() >= 0 && video.time() <= 71) {
      ...
      if (video.time() >= 5 && video.time() <= 8) {
      
        sinFloatQR = sin(map(video.time(), 5, 8, -HALF_PI, HALF_PI));
        
      }
      
      if (video.time() >= 66 && video.time() <= 69) {
      
        sinFloatQR = sin(map(video.time(), 66, 69, HALF_PI, -HALF_PI));
